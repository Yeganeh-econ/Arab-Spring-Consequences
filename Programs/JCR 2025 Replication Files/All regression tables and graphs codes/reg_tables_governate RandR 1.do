...
*               REGRESSION TABLES  : 
*======================================================================================	
*Table 5.1: Effect of Egyptian Protests on Missing Women - droped post time dummy veriable and add fixed year effects
*Table 5,1 Panel A: Missing women	
if `table'==5.1 {
	...
	*Model 1 Raw: (only area group dummy, time dummy, and DID interaction term)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5A_`tab'_UR.xls", replace keep(past_group group past)
	...
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5A_`tab'_UR.xls", append keep(past_group group past $xlist) 
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		...
		* The number of missing women per 100,000 women
		...
		save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5A_missing_women.dta", replace
...
if `table'==5.2 {
	...
	*Model 1 Raw: (only area group dummy, time dummy, and DID interaction term)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5B_`tab'_placebo.xls", replace keep(past_group_placebo group past_placebo)
	...
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5B_`tab'_placebo.xls", append keep(past_group_placebo group past_placebo $xlist)
	...
	*Model 3: baseline: model 1 + governates_ur (`group' captured by governates_ur dummies)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5B_`tab'_placebo.xls", append keep(past_group_placebo past_placebo $xlist) 
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		...
		* The number of missing women per 100,000 women
		...
		save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table5B_missing_women_placebo.dta", replace
...
if `table'==6 {
		...
		*Phase 1 (incl. urban) + survey weighting		
			...
			*Treatment and control groups in phase1
			...
			quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table6_Phases_mw.xls", replace keep(past_group past $xlist)
		...
		*Phase 2 (incl. urban) + survey weighting
			...
			*Treatment and control groups in phase2
			...
			quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table6_Phases_mw.xls", append keep(past_group past $xlist)	
		...
		*Phase 4 (incl. urban) + survey weighting
			...
			*The number of missing women per 100,000 women
			...
			save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table6_missing_women_phases.dta", replace	
...
*Table 6.1: Different Phases of Egyptian Protests and Missing Women - removed governates around the treatment and control group classification
if `table'==6.1 {
...
if `table'==8 {
	...
	*cluster: governorates_urban and rural; fixed effect: governorates_urban and rural (baseline, Tab 1, col 3)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",replace keep(past_group past $xlist) ctitle("Baseline")
	...
	*cluster: governorates_urban and rural; fixed effect: governorates (baseline, Tab 1, col 3)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",append keep(past_group past $xlist) ctitle("Clu: g_ur, FE: g")
	...
	*cluster: governorates; fixed effect: governorates_urban and rural (baseline, Tab 1, col 3)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",append keep(past_group past $xlist) ctitle("Clu: g, FE: g_ur")		
	...
	* BS800 cluster: governorates; fixed effect: governorates_urban and rural (baseline, Tab 1, col 3)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",append keep(past_group past $xlist) ctitle("BS800 Clu: g, FE: g_ur")		
	...
	*BS1000 cluster: governorates; fixed effect: governorates_urban and rural (baseline, Tab 1, col 3)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",append keep(past_group past $xlist) ctitle("BS1000 Clu: g, FE: g_ur")		
	...
	*Wild BS (Roodman et al 2018), cluster: governorates; fixed effect: governorates_urban and rural baseline, Tab 1, col 3)		
		...
		est store boot3
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_cluster.xls",append keep(past_group past $xlist) ctitle("wildBS Clu: g, FE: g_ur")		
		...
		*The number of missing women per 100,000 women
		...
		save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table8_missing_women.dta", replace
...
if `table'==9 {
	...
	*Model 1: Women aged 20-40. (Only 20 to 40 years old)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table9_robustness.xls", replace keep(past_group past $xlist)
		restore
	...
	*Model 2: Interview: no husband. (without husband at the interview)
		...
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table9_robustness.xls", append keep(past_group past $xlist)
		restore
	...
	*Model 6: No Cairo
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table9_robustness.xls", append keep(past_group group past $xlist) 
		restore	
	...
	*Model 8: Treatment and control groups by election results in 2012. 75% support of Moris
	...
	est tab sample2040 sample_noh sample_alone sample_border sample_SYPE sample_noCairo sample_noAlexandria sample_election75 , keep(past_group) title("`tab'") star(0.1 0.05 0.01) stats(N r2) b(%7.3f)
		...
		* The number of missing women per 100,000 women
		...
		save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table9_missing_women_robustness.dta", replace
...
if `table'==10 {
		...
		*Model 1: age1 group - baseline result in table 5.1
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table10_different_ages.xls", replace keep(past_group group past $xlist)
		...
		*Model 2: age19 group		
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table10_different_ages.xls",	append keep(past_group past $xlist)
		...
		* The number of missing women per 100,000 women
		...
		save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table10_different_ages.dta", replace
