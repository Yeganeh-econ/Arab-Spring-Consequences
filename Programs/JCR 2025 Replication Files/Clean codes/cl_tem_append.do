...
* Calculation of dependent variables
	...
	* Treatment and control area dummy variables using the JDE method for R and R 1 comment 9
	* Create treatment and control area dummy variable using the JDE method for R&R Comment 9
	recode governorate (1 2 3 4 19 21 = 1) ///
					  (12 13 14 15 16 17 18 25 26 27 28 29 = 0), ///
					  gen(tgoverRR)

	* Set all other governorates not included in recode to missing
	replace tgoverRR = . if !inlist(governorate, 1, 2, 3, 4, 19, 21, 12, 13, 14, 15, 16, 17, 18, 25, 26, 27, 28, 29)

	* Label the new variable and its values
	label var tgoverRR "Treatment Areas (R&R Method)"
	label define treatmentd 1 "Treated" 0 "Control"
	label values tgoverRR treatmentd
	...
	* Treatment and control area dummy variables - Phase 1 death (Removed edge governates) for R and R 1 Comment 9
	...
	* Treatment and control area dummy variables - Phase 2 death (Removed edge governates) for R and R 1 Comment 9
	...
	replace tgover2dR=. if tgover2d==31| tgover2d==32| tgover2d==33| tgover2d==11| tgover2d==13| tgover2d==14| tgover2d==16| tgover2d==18| tgover2d==23| tgover2d==28| tgover2d==29
	...
	* Treatment and control area dummy variables - phase 3 death (Removed edge governates) for R and R 1 Comment 9
	...
	* Treatment and control area dummy variables - phase 4 death (Removed edge governates) for R and R 1 Comment 9
