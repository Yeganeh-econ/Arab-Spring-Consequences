...
if `table'==5 {	
	...
	*Model 1 Baseline: including all control variables (age, education, etc)
		...
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA5_Domestic_Violence_During_Pregnancy.xls", replace keep(past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p) 
	...
	*Model 2: baseline model 1 + governates_ur (`group' captured by governates_ur dummies) - absorb (clusterid) and group highly corralated
		...
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA5_Domestic_Violence_During_Pregnancy.xls", append keep(past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
	...
	*Model 4: model 2 + survey weighting
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA5_Domestic_Violence_During_Pregnancy.xls", append keep(work past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.1 {	
	...
	*Model 1 Raw: (All dummies and interactons)
		...
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.1_Making_Decisions_Own_Health.xls", replace keep(past_group group past) dec(3) pdec(3) e(r2_p)
	...
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		...
		quietly est store model_2
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.1_Making_Decisions_Own_Health.xls", append keep(past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p) 
	...
	*Model 4: model 3 + PS reweighting
		...
		quietly est store m3_psr
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.1_Making_Decisions_Own_Healthh.xls", append keep(past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
	...
	*Model 5: model 3 + survey weighting
		...
		quietly est store m1_sw
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.1_Making_Decisions_Own_Health.xls", append keep(work past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.2 {	
	...
	*Model 1 Raw: (All dummies and interactons)
		...
		quietly est store model_raw
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.2_Making_Decisions_to_Purchase.xls", replace keep(past_group group past) dec(3) pdec(3) e(r2_p)
			
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		quietly xi: logit pur_ternary past_group group past  $xlist1
		quietly est store model_2
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.2_Making_Decisions_to_Purchase.xls", append keep(past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
	...
	*Model 5: model 3 + survey weighting
		...
		quietly est store m1_sw
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Appen_TableA10.2_Making_Decisions_to_Purchase.xls", append keep(work past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.3 {	
	...
	*Model 1 Raw: (All dummies and interactons)
		...
		quietly est store model_raw
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\TableA10.3_Visiting_Family_Members.xls", replace keep(past_group group past) dec(3) pdec(3) e(r2_p)
			
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		quietly xi: logit visit_ternary past_group group past  $xlist1
		quietly est store model_2
		quietly outreg2 using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\TableA10.3_Visiting_Family_Members.xls", append keep(past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
	...
	*Model 5: model 3 + survey weighting
		...
		quietly est store m1_sw
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\TableA10.3_Visiting_Family_Members.xls", append keep(work past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
