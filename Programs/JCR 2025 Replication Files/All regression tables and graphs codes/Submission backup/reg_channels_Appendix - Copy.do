...
if `table'==9 {
	...
	*Model 1 Raw: (only area group dummy, time dummy, and DID interaction term)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table_A8_Vaccine_rate.xls", replace keep(past_group group past)
	...
	*Model 2 Baseline: model 1 + all control variables (age, education, etc)
		...
		quietly outreg2 using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Table_A8_Vaccine_rate.xls", append keep(past_group group past $xlist) 
