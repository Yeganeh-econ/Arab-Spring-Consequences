...
twoway ///
    (scatter nGovernates de_agg, ///
         xline(1.175647, lp(dash) lcolor(black)) ///
         mcolor(black) msymbol(sh) mlabsize(vsmall)) ///
    (scatter nGovernates inj_agg, ///
         xline(14.08108, lp(dash) lcolor(blue)) ///
         mcolor(blue) msymbol(dh) mlabsize(vsmall)) ///
    (scatter nGovernates arr_agg, ///
         xline(36.5512, lp(dash) lcolor(purple)) ///
         mcolor(purple) msymbol(th) mlabsize(vsmall)) ///
    (scatter nGovernates total_agg, ///
         xline(47.54137, lp(dash) lcolor(orange)) ///
         mcolor(orange) msymbol(o) mlabsize(vsmall)), ///
    ...
    ylabel(30 "Suez" 29 "Port said" 28 "Cairo" 27 "Alexandria" 26 "Ismailia" ///
           ...
           15 "Kafr elsheikh" 14 "Dakahlia" 13 "Gharbia" 12 "Asyout" ///
           11 "Sharkia" 10 "Behera" 9 "Aswan" 8 "Luxur" 7 "Suhag" 6 "Kalyoubia" ///
           5 "Minoufia" 4 "Qena", labsize(vsmall) angle(0)) ///
...
* Recode the variable nGovernates for selected governates
...
* Create the scatter plot with the legend placed below the plot area
...
* Assign numeric codes to the 'Governates'
...
* For classification visual – recode governate numbers
replace nGovernates = 3  if Governates == "Fayoum"
...
twoway (scatter nGovernates de_ph3, ///
  ...
  ylabel(30 "Suez" 29 "Port said" 28 "Cairo" 27 "Alexandria" 26 "Ismailia" ///
         25 "Menia" 24 "Giza" 2 "Damietta" 3 "Fayoum" 21 "Beni suef" ///
         15 "Kafr elsheikh" 14 "Dakahlia" 13 "Gharbia" 12 "Asyout" ///
         11 "Sharkia" 23 "Behera" 9 "Aswan" 8 "Luxur" 22 "Suhag" ///
         31 "Kalyoubia" 5 "Minoufia" 4 "Qena", ///
		 labsize(tiny) angle(0)) ///
...
twoway ///
    ...
    ylabel(30 "Suez" 29 "Port said" 28 "Cairo" 27 "Alexandria" 26 "Ismailia" 25 "Menia" ///
           24 "Giza" 23 "Damietta" 22 "Fayoum" 21 "Beni suef" 15 "Kafr elsheikh" ///
           14 "Dakahlia" 13 "Gharbia" 12 "Asyout" 11 "Sharkia" 10 "Behera" 9 "Aswan" ///
           8 "Luxur" 31 "Suhag" 6 "Kalyoubia" 5 "Minoufia" 4 "Qena", labsize(tiny) angle(0)) ///
...
use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\data\data_cleaning\Cleaned SYPE\cr_SYPE", clear
    ...
    * Create the scatter plot with custom labels and added note
    twoway (scatter governates protest_intensity, ///
           ...
           ylabel(41 "Cairo" 40 "Alexandria" 39 "Port said" 38 "Suez" ///
                  37 "Giza" 36 "Damietta" 35 "Sharkia" 34 "Kalyoubia" 33 "Minoufia" ///
                  32 "Ismailia" 31 "Fayoum" 14 "Luxur" 15 "Aswan" 16 "Qena" ///
                  17 "Suhag" 18 "Behera" 19 "Dakahlia" 20 "Kafr elsheikh" 21 "Gharbia" ///
                  22 "Beni suef" 24 "Menia" 23 "Asyout", labsize(vsmall) angle(0)) ///
           xtitle("Protest participation intensity") ///
           ytitle("Control                           Treatment") ///
