...
* Vaccination ratio (All graphs divided into two sections)
* Figure 6. Possible influential channels - Vaccination female/male ratio

* Ratio of female vaccine
use "cr_master_UR.dta", clear
drop if vaccination == .
...
graph export "C:\Users\zheng\Dropbox\Papers_with_Zhengang\arab_spring_missing_women\results\Figure6_common_trend_ray'smeasure.pdf", replace
	
* Ratio of male vaccine
use "cr_master_UR.dta", clear
drop if vaccination == .
