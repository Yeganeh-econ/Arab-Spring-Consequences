...
if `table'==9.1 {	
	...
	*Model 5: model 3 + survey weighting
		...
		quietly est store m1_sw
		quietly outreg2 using  "TableA9.1.xls", append keep(work past_group group past $xlist2) dec(3) pdec(3) e(r2_p)

	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: probit work past_group past group $xlist2 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA9.1.xls", append keep(work past_group group past $xlist2) dec(3) pdec(3) e(r2_p)
...
if `table'==9.2 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: logit work past_group past group $xlist2 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA9.2.xls", append keep(work past_group group past $xlist2) dec(3) pdec(3) e(r2_p)
...
if `table'==10.1 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: probit visit_ternary past_group past group $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.1.xls", append keep(work past_group group past $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.2 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: logit visit_ternary past_group past group  $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.2.xls", append keep(work past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.3 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: probit pur_ternary past_group past group  $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.3.xls", append keep(work past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.4 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: logit pur_ternary past_group past group  $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.4.xls", append keep(work past_group group past  $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.5 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: probit health_ternary past_group past group  $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.5.xls", append keep(work past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
...
if `table'==10.6 {	
	...
	*Model 6: model 3 + self-created weighting (age, education, etc)
		quietly xi: logit health_ternary past_group past group  $xlist1 [pweight=share_pop], cluster(clusterid)
		quietly est store model3_sweight
		quietly outreg2 using  "TableA10.6.xls", append keep(work past_group group past b_gender $xlist1) dec(3) pdec(3) e(r2_p)
