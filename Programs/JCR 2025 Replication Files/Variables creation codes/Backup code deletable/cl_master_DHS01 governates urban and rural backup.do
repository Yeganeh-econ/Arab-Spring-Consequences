...
*age1
	forvalues i=2007(1)2014 {
		...
		use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned DHS\tem_append", clear
		keep if kidage`i'==0| kidage`i'==1
			
		g year=`i'
		
		save  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age`i'_1_UR", replace
		
	}
											
	use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2007_1_UR", clear	
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2008_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2009_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2010_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2011_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2012_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2013_1_UR"
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age2014_1_UR"		
	
	save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\tem_master_age1_UR", replace
	
	*erase all temperary data sets
	forvalues i=2007(1)2014 {
		
		erase  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_age`i'_1_UR.dta"
...
*summary tables	
	...
	*merge with developed reference governates_urs
	merge m:1 id using  "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned Developed\agg_developedindex_WRages"
...
*save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Try\cr_master_age1_UR20071", replace
//save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\tem_master_age1_UR", replace
	...
	* domestic violence rate during pregency
	...
	* domestic violence rate during pregency - different age groups
	
	* bysort governates_ur year: egen dv_num=sum(dv_preg) if dv_preg==1 & pregnecy==1 & (age>=15&age<=24)
	* bysort governates_ur year: egen p_subgroups1=sum(pregnecy) & (age>=15&age<=24)
	* bysort governates_ur year: g dv_rate01=dv_num/p_subgroups1& (age>=15&age<=24)
	...
	* respondent labor participation rate - aggregate level
	...
	* respondent labor participation rate - different ages groups
	...
	* Average Birth Space between children
	
	* Dep Var: A Dummy Variable whether a kid was dead within 12 months of birth
	g d_12m_indicator = 0
	replace d_12m_indicator = 1 if dage <= 1
	
	* Education and wealth dummy variables
	g noeducation= (education==0)
	g primary= (education==1)
	g secondary= (education==2)
	g higher= (education==3)
	
	* Husband Education and wealth dummy variables
    ...
    * Domestic Violence 
	...
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned DHS\lpfp_2008.dta"
	
save "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\tem_master_age1_UR_OLDSTATA", replace	

* This do file can run more than two hours. It is better to do the following step.
* Step 1: use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\tem_master_age1_UR", clear
* Step 2: create all new variables
* Step 3: run the cl_collapse.do
* Step 4: run cl_master_merge_all_age_groups

exit
* the following is the same as cl_collapse.do, so do not worry about it.




**************************************************************************************************
use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\tem_master_age1_UR", clear
count
drop if year_indicator==2008
count
...
drop _merge 
	...
	* birth-weight ratio etween girls and boys
	...
	* indicator if it is 2008 information
	g year_indicator=2014
	
	* append 2008 labor force participation information 
	append using "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned DHS\lp_2008.dta"
...
exit
*erase "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned final data set\tem_master_age1_UR.dta"
use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Publication code\cr_master_age1_UR2007", clear
...
use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Data\Cleaned\Cleaned DHS\lp_2008.dta", clear


use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Try\cr_master_age1_UR2007", clear
use "C:\Users\zheng\Dropbox\Papers_with_Zhengang\Codes\Try\cr_master_age1_UR20071", clear
	*Aggre level - border governates dummy
